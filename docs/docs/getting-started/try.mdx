---
title: Try Re in Act
description: "Two ways to try Re in Act: a direct Bash RAS setup with reason and act, and a fast proxy launch path."
---
...
2. **Fast proxy experience** — launch a tool through `@one-agent/ria-proxy` and immediately experience Re in Act mode.
