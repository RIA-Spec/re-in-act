...
const CODE_LINES = [
  ...
  { text: "    ['Goal: pick the retry step.',", cls: "" },
  { text: "     observation, 'Relevant context: latest CI run.',", cls: "" },
  { text: "     'Constraints: return retry_cmd + reason only.'],", cls: "" },
  { text: '    {"retry_cmd": "", "reason": ""},', cls: "" },
  { text: ")", cls: "kw" },
  { text: "", cls: "" },
  { text: "retry_run = await act('bash', focus['data']['retry_cmd'])", cls: "act" },
  { text: "decision = await reason(", cls: "kw" },
  { text: "    ['Goal: continue or escalate?',", cls: "" },
  { text: "     retry_run['content'][0]['text'], focus['data']['reason'],", cls: "" },
  { text: "     'Constraints: return action + reason only.'],", cls: "" },
  ...
  { text: "    print(decision['data']['reason'])", cls: "" },
  { text: "else:", cls: "kw" },
  { text: "    await act('deploy', {'target': 'production'})", cls: "act" },
  { text: "    print('deployed')", cls: "" },
];
